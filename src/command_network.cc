...
initialize_command_network() {
  ...
  // TODO: Remove port_open
  // CMD_VAR_BOOL    ("network.port_open",   true);
  // CMD_VAR_BOOL    ("network.port_random", true);
  // CMD_VAR_STRING  ("network.port_range",  "6881-6999");

  CMD_ANY         ("network.port_random",        [](auto, auto)                 { return torrent::runtime::client_config()->listen_port_random(); });
  CMD_ANY_VALUE_V ("network.port_random.set",    [](auto, auto& value)          { return torrent::runtime::client_config()->set_listen_port_random(value); });
  CMD_ANY         ("network.port_range",         [](auto, auto)                 { return listen_port_range(); });
  CMD_ANY_STRING_V("network.port_range.set",     [](auto, auto& value)          { return set_listen_port_range(value); });
