...
ElementFileList::ElementFileList(core::Download* d) :
  ...
  m_bindings[KEY_RIGHT] = m_bindings[control->ui()->get_keymap(RT_KEY_RIGHT)] = std::bind(&ElementFileList::receive_select, this);
  ...
  m_bindings[KEY_DOWN]  = m_bindings[control->ui()->get_keymap(RT_KEY_DOWN)]  = std::bind(&ElementFileList::receive_next, this);
  m_bindings[KEY_UP]    = m_bindings[control->ui()->get_keymap(RT_KEY_UP)]    = std::bind(&ElementFileList::receive_prev, this);
}
