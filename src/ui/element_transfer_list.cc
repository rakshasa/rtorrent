...
ElementTransferList::ElementTransferList(core::Download* d) :
  ...
  m_bindings[KEY_DOWN]  = m_bindings[control->ui()->get_keymap(input::RT_KEY_DOWN)]  = std::bind(&ElementTransferList::receive_next, this);
  m_bindings[KEY_UP]    = m_bindings[control->ui()->get_keymap(input::RT_KEY_UP)]    = std::bind(&ElementTransferList::receive_prev, this);
