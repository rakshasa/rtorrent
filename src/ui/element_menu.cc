...
ElementMenu::ElementMenu() :
  ...
  m_bindings[KEY_RIGHT] = m_bindings[control->ui()->get_keymap(RT_KEY_RIGHT)] = std::bind(&ElementMenu::entry_select, this);

  m_bindings[KEY_UP]    = m_bindings[control->ui()->get_keymap(RT_KEY_UP)]    = std::bind(&ElementMenu::entry_prev, this);
  m_bindings[KEY_DOWN]  = m_bindings[control->ui()->get_keymap(RT_KEY_DOWN)]  = std::bind(&ElementMenu::entry_next, this);
}
