...
ElementChunksSeen::ElementChunksSeen(core::Download* d) :
  ...
  m_bindings[KEY_DOWN]  = m_bindings[control->ui()->get_keymap(input::RT_KEY_DOWN)] = std::bind(&ElementChunksSeen::receive_next, this);
  m_bindings[KEY_UP]    = m_bindings[control->ui()->get_keymap(input::RT_KEY_UP)]   = std::bind(&ElementChunksSeen::receive_prev, this);
