...
char*       print_status_throttle_limit(char* first, char* last, bool up, const std::vector<std::string>& throttle_names, double factor, int prec);
char*       print_status_throttle_rate(char* first, char* last, bool up, const std::vector<std::string>& throttle_names, const double& global_rate, double factor, int prec);
